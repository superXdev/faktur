        ...
        <table >
            ...
            <tbody>
            	...
            	<td>{{ $no }}</td>
						...
						<td style="text-align: right; font-weight: bold;">{{ 	number_format($V->hargaJual,0, ',' , '.') }}</td>
						<td style="text-align: right; font-weight: bold;">{{ 	number_format($V->jumlah_harga,0, ',' , '.') }}</td>
					</tr>
                    @endforeach
					<tr>
						<td></td>
						...
						<td style="text-align: right;"><b>{{ 	number_format($data->grandTotal,0, ',' , '.') }}</b></td>
					</tr>
            </tbody>
        </table>
