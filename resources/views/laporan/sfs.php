...
class LaporanController extends Controller
{
    ...
    public function update($id)
    {
        ...
        // $dd=terbilang($data['grandTotal'],'rupiah','senilai'); // one million
...
@page { margin: 0; }
	...
	<body>
		...
		<article>
            <table>
                <tr>
                    <td colspan="2"><center>ABIDZAKY SUPPLIER</center></td>
                    <td colspan="2"><center>INVOICE</center></td>
                </tr>
                <tr>
                    <td rowspan="2">
                        <img src="{{asset('logo.png')  }}" alt="" width="70px" style="display: block; margin: auto;"></td>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span contenteditable>ITEM BARANG</span></th>
				...
				<tbody>
                    ...
                    <?php $no++ ;?>
					<tr>
						<td><a class="cut">-</a><span contenteditable>{{ $no }}</span></td>
						<td><span contenteditable>{{ $V->namaBarang }}({{ $V->satuan }})</span></td>
